...
![Descripción de la imagen](../img/UT2/Wordperfect-5.1-dos.png){ .sietecinco }
...
!!! exercise "Ejemplo de colaboración"
    1. Crear un documento de texto con **Microsoft 365 Copilot**.
    1. Poneros los 2 a escribir y comprobar el resultado.
...
1. Todos los procesadores de texto incluyen **correctores de ortografía y gramática** y un **diccionario de sinónimos** para ayudar a encontrar las palabras adecuadas.
1. Los procesadores de texto no solo corrigen errores, sino que también:  
...
- Los procesadores de texto ofrecen una gran flexibilidad al momento de guardar documentos.
- Se puede elegir entre una amplia variedad de **formatos de archivo**, como `.docx`, `.pdf` o `.odt`, lo que maximiza la compatibilidad del documento entre plataformas.  
...
!!! tip "Nota"
    Este documento está escrito con un procesador de textos **WYSIWYM**.
